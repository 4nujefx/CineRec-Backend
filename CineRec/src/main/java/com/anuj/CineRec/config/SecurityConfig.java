    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/Movies/add/**","/Genre/add/Genre").hasRole("ADMIN")
                        .requestMatchers("/USER/**").permitAll() // allow signup
                        .requestMatchers("/Movies/AllMovies","/Genre/genres").hasRole("USER")
